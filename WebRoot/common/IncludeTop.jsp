...
<div id="Header">
  ...
  <div id="Menu">
    <div id="MenuContent">
          <a href="CartAction"><img align="middle" name="img_cart" src="<%=basePath%>/images/cart.gif" /></a>
      
         <img align="middle" src="<%=basePath%>/images/separator.gif"/>
      
       <a href="<%=basePath%>account/SignonForm.jsp">登录</a>
       <img align="middle" src="<%=basePath%>/images/separator.gif"/>
       <a href="<%=basePath%>/account/EditAccountForm.jsp">我的账户</a>
    </div>
  </div>

  <div id="Search">
    <div id="SearchContent">
      <form method="get" action="TypeAction">
